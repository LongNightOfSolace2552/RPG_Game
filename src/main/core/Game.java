...
public class Game {
    ...
    private static final String DEFAULT_STARTING_NODE = "Starting Village";
    ...
    //start game, handles player's input
    public void start() {
        Player player = initializePlayer();

        boolean running = true;
        while (running) {
            consoleRenderer.printHeader(player);
    ...
    //loads player or start new game
    ...
    private Player createNewPlayer() {
        ...
        return new Player(name, startingStats, DEFAULT_STARTING_NODE);
    }
}
